...
echo -e "\nPreparing statusbar iOS layout mod.."
'../../tools/apktool' --quiet d -f '../out/system/priv-app/MiuiSystemUI.apk'
cp -r ../overlay/MiuiSystemUI/* MiuiSystemUI/res/layout
'../../tools/apktool' --quiet b -f 'MiuiSystemUI' 'patched-MiuiSystemUI.apk'
mkdir -p ui/res/layout
cd ui/res
unzip -j -q '../../patched-MiuiSystemUI.apk' res/layout/signal_cluster_view.xml -d 'layout'
unzip -j -q '../../patched-MiuiSystemUI.apk' res/layout/status_bar.xml -d 'layout'
